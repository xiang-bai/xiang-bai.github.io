...
- **系数矩阵是标准型的二阶线性系统的轨线分布**：考虑系统为
 ...
 \end{equation}
 不妨设$\vert \mu \vert >\vert \lambda \vert$，下面讨论$\mu,\lambda$的符号。
 - **case1：$\mu,\lambda$同号**：有$\frac{\mu}{\lambda}>0$故轨线为抛物型，并且对于$\mu<\lambda<0$时，当$t\to +\infty$时趋于原点，对于$0<\lambda<\mu$，当$t\to -\infty$时趋于原点，即图像如下    
 <!-- <br> -->
 <table border="1">
   <tr>
     <th><img src="http://13ai.github.io/images/stable_nodal_point.png" height = "200" alt="稳定结点"/></th>
     <th><img src="http://13ai.github.io/images/unstable_nodal_point.png" height = "200" alt="不稳定结点"/></th>
   </tr>
   <tr>
     <td>稳定结点</td>
     <td>不稳定结点</td>
